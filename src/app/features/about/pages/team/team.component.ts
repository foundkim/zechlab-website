  ...
  teamCards = [
    {
      ...
      actions: [
        ...
        { icon: 'email', label: 'Envoyer un e-mail', link: 'mailto:contact@edi.co.ke' }
      ]
    },
    {
      ...
      actions: [
        { icon: 'location_on', label: 'Itinéraire', link: '#' },
        { icon: 'email', label: 'Envoyer un mail', link: 'mailto:contact@edi.ci' }
      ]
    },
    {
    title: 'Christopher TULLIS, Sénégal',
    addressLines: [
      'Spécialiste des services digitaux et de la microfinance'
    ],
    phone: '+221 33 820 45 00',
    photo: 'assets/images/Kars.png',
    actions: [
      { icon: 'location_on', label: 'Itinéraire', link: '#' },
      { icon: 'email', label: 'Envoyer un e-mail', link: 'mailto:contact@edi.sn' }
    ]
  },
  {
    title: 'Dede ADUAYOM-HOUETO, Bénin',
    addressLines: [
      'Agroéconomiste, spécialiste des évaluations',
    ],
    phone: '+229 21 30 40 50',
    photo: 'assets/images/Kars.png',
    actions: [
      { icon: 'location_on', label: 'Itinéraire', link: '#' },
      { icon: 'email', label: 'Envoyer un e-mail', link: 'mailto:contact@edi.bj' }
    ]
  },
  {
    ...
    actions: [
      { icon: 'location_on', label: 'Itinéraire', link: '#' },
      { icon: 'email', label: 'Envoyer un e-mail', link: 'mailto:contact@edi.gh' }
    ]
  },
  {
    title: 'Thierry HOUNSA, Ghana',
    addressLines: [
      'Spécialiste en Analyse de pauvreté',
    ],
    phone: '+233 30 266 1234',
    photo: 'assets/images/Kars.png',
    actions: [
